...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public void logar() {
        String sql = "select * from usuarios where email=? OR login=? and senha=?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, txtUsuario.getText()); // Email
            pst.setString(2, txtUsuario.getText()); // Login (mesmo campo usado para email)
            String captura = new String(txtSenha.getPassword());
            pst.setString(3, captura); // Senha
