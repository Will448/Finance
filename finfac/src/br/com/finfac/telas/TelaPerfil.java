...
public class TelaPerfil extends javax.swing.JInternalFrame {
    ...
    private void pesquisar_gastoevento() {
        String sql = "SELECT Gastos.valor AS 'Valor', Gastos.descricao AS 'Descrição', Gastos.meiopagamento AS 'Forma de pagamento', Gastos.situacao AS 'Situação'" +
                ", Evento.descricao AS 'Descrição', Evento.dataevento AS 'Data do evento', Evento.localevento as 'Local' "
